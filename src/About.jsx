    ...
    <div className="about-container">
      ...
      <div className="about-text-container">
        <h3 className="about-text">
          ...
          engaging, dynamic, and performative web projects. Additional professional skills in Marketing and Graphic Design composes a well-rounded skillset to tackle any project, simple or complex.
        </h3>
      </div>
    </div>
  );
